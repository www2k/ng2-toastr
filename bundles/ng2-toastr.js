  ...
  var ToastContainer = (function() {
    ...
    ToastContainer.decorators = [{
      ...
      args: [{
        ...
        animations: [core_1.trigger('flyInOut', [core_1.state('fly', core_1.style({
          opacity: 1,
          transform: 'translateX(0)'
        })), core_1.transition('void => *', [core_1.style({
          opacity: 0,
          transform: 'translateX(100%)'
        }), core_1.animate('0.2s ease-in')]), core_1.transition('* => void', [core_1.animate('0.2s 10 ease-out', core_1.style({
          opacity: 0,
          transform: 'translateX(100%)'
        }))])]), core_1.trigger('fadeInOut', [core_1.state('fade', core_1.style({opacity: 1})), core_1.transition('void => *', [core_1.style({opacity: 0}), core_1.animate('0.3s ease-in')]), core_1.transition('* => void', [core_1.animate('0.3s 10 ease-out', core_1.style({opacity: 0}))])])]
      }]
    }];

  ...
  var ToastContainer = (function() {
    ...
    ToastContainer.decorators = [{
      ...
      args: [{
        ...
        animations: [core_1.trigger('inOut', [core_1.state('in', core_1.style({
          opacity: 1,
          transform: 'translateX(0)'
        })), core_1.transition('void => in', [core_1.style({
          opacity: 0,
          transform: 'translateX(100%)'
        }), core_1.animate('0.2s ease-in')]), core_1.transition('in => void', [core_1.animate('0.2s 10 ease-out', core_1.style({
          opacity: 0,
          transform: 'translateX(100%)'
        }))])])]
      }]
